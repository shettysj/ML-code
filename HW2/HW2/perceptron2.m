...
for i=1:240
    TrainingSet(i,1)= normL(test_2(i),:);
    TrainingSet(i,2)= normP(test_2(i),:);
    TrainingSet2(i,:)= data2(test_2(i),:);
end
for i=241:300
    TestingSet(count,1)= normL(test_2(i),:);
     TestingSet(count,2)= normP(test_2(i),:);
...
% TrainingSet(:,1)=normL(1:240,1);
% TrainingSet(:,2)=normP(1:240,1);
% 
...
for r=1:60
   ...
   hit_rate_test(train)=(Q11+Q00)/(Q11+Q10+Q01+Q00); 
end
figure();
